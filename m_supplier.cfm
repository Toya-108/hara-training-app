    ...
    <div class="wrap">
        ...
        <div class="search_area" style="display:flex; margin-top:30px; flex-wrap:wrap;">
            <div class="search_item">
                ...
                <input type="text" id="search_supplier_code" name="search_supplier_code" placeholder="取引先コード" value="#HTMLEditFormat(formSearchSupplierCode)#">
            </div>

            <div class="search_item">
                <label for="search_supplier_name">取引先名</label>
                <input type="text" id="search_supplier_name" name="search_supplier_name" placeholder="取引先名 / 取引先名(カナ)" value="#HTMLEditFormat(formSearchSupplierName)#" style="width:250px;">
            </div>
